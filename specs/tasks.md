...
- [x] **Task 4.3 :** Implémenter la sonde **HTTP/TCP** (mesure TTFB, TLS handshake).
- [x] **Task 4.4 :** Intégrer les calculs de Jitter spécifiques à ces sondes et injecter les résultats dans le provider OTLP.
